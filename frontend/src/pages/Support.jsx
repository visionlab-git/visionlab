...
export default function Support({ onBack }) {
  ...
  const chapterDetails = [
    {
      ...
      features: [
        ...
        },
        {
          ...
          desc: "Re-échantillonnage de l'image lors du redimensionnement.",
          usage: "Choisissez entre 'Plus Proche Voisin' (rapide, aspect pixelisé) ou 'Bilinéaire' (plus lent, aspect lisse) pour observer l'influence mathématique sur la qualité visuelle."
        }
      ]
    },
    {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-blue-500/30 overflow-x-hidden">
      ...
      {/* Header */}
      <header className="fixed top-0 inset-x-0 h-20 glass z-50 border-b border-slate-800/50 px-6 md:px-12 flex items-center justify-between">
        <button 
          onClick={onBack}
          className="flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-slate-800/50 hover:bg-slate-700 transition-all text-sm font-bold uppercase tracking-wider border border-slate-700 group"
        >
          <ChevronLeft size={18} className="group-hover:-translate-x-1 transition-transform" /> Retour au Studio
        </button>
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-black uppercase tracking-tighter">Vision<span className="text-blue-500">Lab</span> Support</h1>
        </div>
        </div>
      </header>

      <main className="relative pt-32 pb-32 px-6 max-w-6xl mx-auto z-10">
        {/* Intro Hero Section */}
        <section className="text-center space-y-10 mb-32 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="inline-flex p-1 bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-[40px] text-blue-500 mb-4 shadow-2xl relative group overflow-hidden border border-slate-800">
            ...
            <img src="/logo.png" alt="VisionLab Big Logo" className="w-32 h-32 object-cover relative z-10" />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 pt-6">
            <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-slate-900/50 border border-slate-800 text-sm font-bold text-slate-400 hover:border-blue-500/30 transition-colors">
              <Terminal size={16} className="text-blue-400" /> Algorithmes JavaScript
            </div>
            <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-slate-900/50 border border-slate-800 text-sm font-bold text-slate-400 hover:border-purple-500/30 transition-colors">
              <Cpu size={16} className="text-purple-400" /> Calcul GPU-Friendly
            </div>
            <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-slate-900/50 border border-slate-800 text-sm font-bold text-slate-400 hover:border-teal-500/30 transition-colors">
              <Layers size={16} className="text-teal-400" /> Traitement Binaire
            </div>
          </div>
        </section>
        ...
        <section className="mb-32 space-y-16">
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <h3 className="text-4xl font-black text-white">Comment démarrer ?</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
                ...
                {[
                    ...
                    <div key={i} className="relative z-10 p-8 rounded-[40px] bg-slate-900/40 border border-slate-800/50 flex flex-col items-center text-center space-y-6">
        ...
        <section className="space-y-20 mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {chapterDetails.map((chapter) => (
              <div 
                key={chapter.id} 
                className={`flex flex-col rounded-[32px] bg-slate-900/40 border transition-all duration-700 overflow-hidden group/card ${
                  expandedSection === chapter.id 
                    ? 'border-blue-500/50 ring-1 ring-blue-500/50 shadow-[0_0_80px_rgba(59,130,246,0.15)] lg:col-span-2 bg-slate-900/80' 
                    : 'border-slate-800/50 hover:bg-slate-900/60 hover:border-slate-700 hover:-translate-y-1'
                }`}
              >
                <div className="p-10 flex-1 space-y-8">
                  <div className="flex items-center justify-between">
                    <div className="p-5 bg-slate-950 border border-slate-800 rounded-3xl shadow-inner group-hover/card:scale-110 transition-transform duration-500">
                      {chapter.icon}
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest bg-slate-950 px-4 py-1.5 rounded-full border border-slate-800">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-3xl font-black text-white group-hover/card:text-blue-400 transition-colors">{chapter.title}</h4>
                    <p className="text-slate-400 text-base leading-relaxed font-medium">{chapter.shortDesc}</p>
                  </div>

                  {expandedSection === chapter.id && (
                    <div className="pt-10 border-t border-slate-800 animate-in fade-in zoom-in duration-700">
                      <div className="grid md:grid-cols-2 gap-12">
                          <div className="space-y-10">
                            ...
                            {chapter.features.map((feature, idx) => (
                                <div key={idx} className="group/feat space-y-4 p-6 rounded-3xl bg-slate-950/50 border border-slate-800 transition-all hover:border-blue-500/30">
                                    <div className="flex items-center gap-3">
                          ...
                          <div className="space-y-8">
                            ...
                            <div className="p-8 rounded-[40px] bg-slate-950 border border-slate-800 space-y-6">
                                <div className="flex items-center gap-3">
                            ...
                            <div className="p-8 rounded-[40px] bg-gradient-to-br from-blue-600/5 to-indigo-600/5 border border-indigo-500/10 space-y-4">
        ...
        <section className="mb-48 grid lg:grid-cols-1 gap-8">
           <div className="flex flex-col items-center gap-4 text-center mb-12">
              ...
              <h3 className="text-4xl font-black text-white">Questions Fréquentes</h3>
           </div>
           ...
           <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="p-8 rounded-[40px] bg-white/5 border border-white/5 space-y-4 hover:border-white/10 transition-all group">
                  <div className="flex items-center gap-4">
        ...
        <section className="grid lg:grid-cols-2 gap-20 items-start mb-48">
          <div className="space-y-12">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-blue-500/10 text-blue-400 text-xs font-black uppercase tracking-[0.2em] border border-blue-500/20">
                Pôle Excellence Académique
              </div>
              <h2 className="text-6xl font-black text-white leading-[1] tracking-tighter">Université de <br/>Yaoundé 1</h2>
            ...
            <div className="grid gap-8">
              <div className="group flex items-start gap-8 p-10 rounded-[48px] bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 shadow-xl transition-all hover:border-blue-500/30 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 blur-[60px]"></div>
                <div className="p-5 bg-blue-600 rounded-[28px] text-white shadow-2xl shadow-blue-600/40 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                  <User size={32} />
                </div>
                <div className="space-y-3">
                  <h4 className="text-[10px] font-black text-blue-400 uppercase tracking-[0.3em] mb-1">Supervision Académique</h4>
                  <p className="text-3xl font-black text-white tracking-tighter leading-none">Pr TAPAMO KENFACK HIPPOLYTE</p>
              ...
              <div className="group flex items-start gap-8 p-10 rounded-[48px] bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 shadow-xl transition-all hover:border-purple-500/30 relative overflow-hidden">
                <div className="absolute bottom-0 right-0 w-32 h-32 bg-purple-500/10 blur-[60px]"></div>
                <div className="p-5 bg-purple-600 rounded-[28px] text-white shadow-2xl shadow-purple-600/40 group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500">
                  <GraduationCap size={32} />
                </div>
                <div className="space-y-3">
                  <h4 className="text-[10px] font-black text-purple-400 uppercase tracking-[0.3em] mb-1">Architecture & Code</h4>
                  <p className="text-3xl font-black text-white tracking-tighter leading-none">NASSARAMADJI NASAIRE</p>
                  <p className="text-sm text-slate-500 font-medium leading-relaxed">Étudiant Licence 3 - Informatique (Promotion 2026).</p>
                </div>
              </div>
            </div>
            
            <div className="flex items-center gap-8 pt-8 px-6">
          ...
          <div className="sticky top-32 glass-panel p-12 rounded-[56px] space-y-12 border-slate-700/30 shadow-[0_50px_150px_rgba(0,0,0,0.5)] relative overflow-hidden group/formCard">
            ...
            <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-3">
                    <h3 className="text-4xl font-black text-white tracking-tighter leading-none">Restons en Contact</h3>
            ...
            <div className="grid gap-5 relative z-10">
              <a 
                ...
                className="flex items-center justify-between p-8 rounded-[36px] bg-slate-900/40 hover:bg-slate-800 border border-slate-800/50 hover:border-blue-500/50 transition-all group/link"
              >
                <div className="flex items-center gap-6">
                  <div className="p-4 bg-blue-600/10 rounded-2xl text-blue-400 group-hover/link:bg-blue-600 group-hover/link:text-white group-hover/link:shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-all duration-500">
                    <Mail size={24} />
                  </div>
                  <div className="text-left space-y-1">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Support Technique</p>
                    <span className="font-bold text-base text-slate-100 italic">visionlab.contacts@gmail.com</span>
                  </div>
                </div>
              ...
              <a 
                ...
                className="flex items-center justify-between p-8 rounded-[36px] bg-slate-900/40 hover:bg-slate-800 border border-slate-800/50 hover:border-green-500/50 transition-all group/link"
              >
                <div className="flex items-center gap-6">
                  <div className="p-4 bg-green-600/10 rounded-2xl text-green-400 group-hover/link:bg-green-600 group-hover/link:text-white group-hover/link:shadow-[0_0_20px_rgba(34,197,94,0.5)] transition-all duration-500">
                    <MessageCircle size={24} />
                  </div>
                  <div className="text-left space-y-1">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Ligne Directe</p>
               ...
               {showDonateSuccess ? (
                 ...
                 <form className="space-y-6 pt-12 border-t border-slate-800 relative z-10">
                  ...
                  <div className="space-y-4">
                      <div className="relative group/input">
                        <input 
                          ...
                          className="w-full bg-slate-950 border border-slate-800 rounded-[28px] px-8 py-6 text-lg font-black focus:outline-none focus:border-blue-500/50 focus:ring-8 focus:ring-blue-500/5 transition-all text-white placeholder:text-slate-700 shadow-inner"
                        />
                      ...
                      <div className="relative group/input">
                        <textarea 
                          ...
                          rows="3"
                          className="w-full bg-slate-950 border border-slate-800 rounded-[28px] px-8 py-6 text-sm font-bold focus:outline-none focus:border-purple-500/50 focus:ring-8 focus:ring-purple-500/5 transition-all text-white placeholder:text-slate-700 shadow-inner resize-none"
                        ></textarea>
                      </div>
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full py-6 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-[28px] font-black uppercase tracking-[0.3em] text-[11px] text-white shadow-[0_20px_50px_rgba(59,130,246,0.35)] hover:shadow-[0_25px_60px_rgba(59,130,246,0.5)] hover:scale-[1.01] active:scale-[0.98] transition-all duration-500 relative overflow-hidden group/btn"
                  >
        ...
        <section className="pt-24 border-t border-slate-900 flex flex-col items-center gap-12">
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-between border-t border-slate-900 pt-12 gap-8">
                <div className="flex items-center gap-8 px-6 py-4 rounded-[40px] bg-slate-950/50 border border-slate-900">
